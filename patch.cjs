const fs = require('fs');
const content = fs.readFileSync('src/components/AdminToolbar.tsx', 'utf8');

const newContent = content.replace(
  /<motion\.div[\s\S]*<\/motion\.div>/,
  `<motion.div 
...
fs.writeFileSync('src/components/AdminToolbar.tsx', newContent);
