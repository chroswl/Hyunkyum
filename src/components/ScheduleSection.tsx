...
export default function ScheduleSection({ items, currentLang, user, onEditItem, onDeleteItem }: ScheduleSectionProps) {
 ...
 className="px-5 py-2 text-[10px] tracking-widest hover:text-black border border-white/25 hover:bg-white transition-all duration-300 rounded-sm uppercase font-sans font-medium whitespace-nowrap"
 >
 Tickets
 </a>
 )
