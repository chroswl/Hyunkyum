      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-[#111] border border-neutral-900 p-6 rounded-lg relative overflow-hidden flex flex-col justify-between group h-full">
          <div>
            ...
            <p className="text-xs text-accent tracking-wider uppercase font-light mt-1">
        ...
        <div className="bg-[#111] border border-neutral-900 p-6 rounded-lg relative overflow-hidden flex flex-col justify-between group h-full">
          <div>
            <div className="flex justify-between items-start">
              <h3 className="text-[10px] font-sans tracking-widest text-accent uppercase mb-4 font-semibold">Global Language Switch</h3>
            ...
            <div className="grid grid-cols-3 gap-1 bg-black p-1 rounded border border-neutral-900">
              {(['EN', 'DE', 'KO'] as const).map(lang => (
                <button
                  ...
                  className={`py-2 text-xs tracking-wider uppercase font-semibold transition-all rounded-[2px] ${currentLang === lang ? 'bg-accent text-black font-bold' : 'text-neutral-400 hover:text-white hover:bg-neutral-900'}`}
                >
                  {lang}
                </button>
              ))}
        ...
        <div className="border border-neutral-900 bg-[#111] p-6 rounded-lg space-y-4">
          ...
          <div className="space-y-4 text-xs font-sans">
            ...
            <div className="flex justify-between border-b border-neutral-900/50 pb-2">
              ...
              <span className="text-accent font-mono font-semibold">{scheduleItems.length}</span>
            </div>
            <div className="flex justify-between pb-1">
              <span className="text-neutral-500 uppercase tracking-widest">Total Photos</span>
              <span className="text-accent font-mono font-semibold">{portfolioItems.length}</span>
            </div>
          </div>
        </div>
